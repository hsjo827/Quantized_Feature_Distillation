...
def define_distill_module_and_loss(model_s, model_t, model_params, args, n_data, train_loader):
    ...
    model_t.eval()
    model_s.eval()
    feat_t, block_out_t,  pool_out_t, logit_t = model_t(data, is_feat=True, flatGroupOut=flatGroupOut) # 수정
    feat_s, block_out_s, pool_out_s, logit_s = model_s(data, is_feat=True, flatGroupOut=flatGroupOut) # 수정
    ...
    elif args.distill == 'feature_kd': # 수정
