...
def load_teacher_model(model_t, teacher_path):
    ...
    # Check for feature_quantizer module
    #has_feature_quantizer = hasattr(model_t, 'feature_quantizer') 
    #print(f"Feature quantizer present in teacher model: {has_feature_quantizer}")

    # Check if QFeatureFlag is present in the args
    #print(f"QFeatureFlag in teacher model: {model_t.args.QFeatureFlag}")
